#!/bin/sh
	...
	#export ARMGCC_DIR=/usr/bin/arm-none-eabi-gcc
	...
	cp ../../src/boot/ksdk1.1.0/devSoilSensor.*			work/demos/Warp/src/
	cp ../../src/boot/ksdk1.1.0/devSI7021_new.*				work/demos/Warp/src/
